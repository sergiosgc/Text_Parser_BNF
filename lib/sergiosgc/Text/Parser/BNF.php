 ...
 *    Goto on   to 5 because of <opt-whitespace>->• <opt-whitespace>
 ...
 *
 */
class Text_Parser_BNF extends \sergiosgc\Text_Parser_LALR
{
    /* Constructor {{{ */
    /**
     * Parser constructor
    ...
    {
        $result = '';
        $result = new \sergiosgc\Text_Tokenizer_Token('<opt-whitespace>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_1 {{{ */
    ...
    $result->setContextFree(true);
        $result = new \sergiosgc\Text_Tokenizer_Token('<grammar>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_2 {{{ */
    ...
    foreach($rule->getValue() as $r) $result->addRule($r);
        $result = new \sergiosgc\Text_Tokenizer_Token('<syntax>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_3 {{{ */
    ...
    protected function &reduce_rule_43(&$text)
    {
        ...
        $result = new \sergiosgc\Text_Tokenizer_Token('<rule-name>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_44 {{{ */
    ...
    {
        $result = func_get_arg(0)->getValue();
        $result = new \sergiosgc\Text_Tokenizer_Token('<unquoted-text>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_45 {{{ */
    ...
    {
        $result = 0;
        $result = new \sergiosgc\Text_Tokenizer_Token('<rule-priority>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_11 {{{ */
    ...
    $result = array($newRule);
        $result = new \sergiosgc\Text_Tokenizer_Token('<expression>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_13 {{{ */
    ...
    protected function &reduce_rule_13(&$term)
    {
        ...
        $result = new \sergiosgc\Text_Tokenizer_Token('<list>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_15 {{{ */
    ...
    {
        $result = func_get_arg(0)->getValue();
        $result = new \sergiosgc\Text_Tokenizer_Token('<term>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_16 {{{ */
    ...
    protected function &reduce_rule_18(&$literal)
    {
        ...
        $result = new \sergiosgc\Text_Tokenizer_Token('<unnamed-term>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_20 {{{ */
    ...
    {
        $result = '';
        $result = new \sergiosgc\Text_Tokenizer_Token('<reduction-code>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_23 {{{ */
    ...
    {
        $result = func_get_arg(0)->getValue();
        $result = new \sergiosgc\Text_Tokenizer_Token('<double-quoted-text>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_24 {{{ */
    ...
    {
        $result = func_get_arg(0)->getValue();
        $result = new \sergiosgc\Text_Tokenizer_Token('<quoted-text-part>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_32 {{{ */
    ...
    {
        $result = func_get_arg(0)->getValue();
        $result = new \sergiosgc\Text_Tokenizer_Token('<single-quoted-text>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_28 {{{ */
    ...
    foreach($result as $i => $rule) {
        ...
        $result = new \sergiosgc\Text_Tokenizer_Token('<rule>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_8 {{{ */
    ...
    {
        $result = '';
        $result = new \sergiosgc\Text_Tokenizer_Token('<line-end>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_7 {{{ */
    ...
    protected function &reduce_rule_21(&$textb)
    {
        $result = '';
    foreach (func_get_args() as $arg) $result .= $arg->getValue();
        $result = new \sergiosgc\Text_Tokenizer_Token('<literal>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_25 {{{ */
    ...
    $result = array(
        ...
        'term' => $unnamedTerm);
        $result = new \sergiosgc\Text_Tokenizer_Token('<named-term>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_50 {{{ */
    ...
    {
        $result = func_get_arg(0)->getValue();
        $result = new \sergiosgc\Text_Tokenizer_Token('<reduction-code-text>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_52 {{{ */
    ...
    {
        $result = func_get_arg(0)->getValue();
        $result = new \sergiosgc\Text_Tokenizer_Token('<reduction-code-text-part>', $result);
        return $result;
    }
    /* }}} */
    /* reduce_rule_53 {{{ */
